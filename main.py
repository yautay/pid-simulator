...
prop = Propeller(diameter=5.1, pitch=4.1, efficiency_factor=1.3)
bat = Battery(cells_no=4, capacity=1600, chemistry="lipo")
model = Model(mass=0.8, size=280, motors=4, motor_kv=1750, propeller=prop, battery=bat, environment=env)
